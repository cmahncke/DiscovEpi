...
class MainWindow4(QMainWindow):
    ...
    def hmp_started(self):
        self.hmsg.setText("Heatmap creation in progress.")
        self.hmsg.setStyleSheet("")
        self.hdirBtn.setEnabled(False)
        self.update_HMPprogress(0)
        print("Heatmaps started")
    ...
    def hmp_finished(self):
        ...
        self.hmsg.setText("Heatmap successfully created.")
    ...
    def hmp_aborted(self):
        self.hmsg.setText("Heatmap creation aborted.")
        self.hmsg.setStyleSheet("color: red")
        self.hdirBtn.setEnabled(False)
        self.update_HMPprogress(0)
        print("Heatmaps aborted")
    ...
    def hmp_empty(self):
        self.hmsg.setText("Error in heatmap. Check your input and try again.")
        self.hmsg.setStyleSheet("color: red")
        self.hdirBtn.setEnabled(False)
        self.update_HMPprogress(0)
        print("Heatmap empty")
