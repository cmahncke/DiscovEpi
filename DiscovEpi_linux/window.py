...
class MainWindow4(QMainWindow):
    def __init__(self):
        ...
        self.org = QLineEdit("SARS-CoV-2", self)
        self.loc = QLineEdit("Membrane", self)
        ...
        hgrid.addWidget(QLabel("Show only top scoring number: "), 1, 0)
        hgrid.addWidget(QLabel("Protein Length Cutoff"), 2, 0)
        hgrid.addWidget(QLabel("Without cutoff every protein will be displayed in full length."), 3, 0, 1, 2)
        self.top = QLineEdit("50", self)
        self.hco = QLineEdit("", self)
        ...
        hgrid.addLayout(hBtnLayout, 4, 0, 1, 2)
        hgrid.addWidget(self.HMPprogressBar, 5, 0, 1, 2)
